    ...
    private JPanel createHomePanel() {
        ...
        description.setText(
                "Welcome to the Restaurant Management System Demo.\n\n" +
                        ...
                        "- Manager approves chef/delivery registrations.\n" +
                ...
                if (isNewBest) {
                    JOptionPane.showMessageDialog(this,
                            "Your bid is currently the lowest.\nYou are assigned to deliver this order.\n" +
                                    "Current best bid: $" + String.format("%.2f", selected.getBestBid()));
                } else {
                    DeliveryPerson best = selected.getAssignedDelivery();
                    if (best != null) {
                        JOptionPane.showMessageDialog(this,
                                "Bid placed, but not the lowest.\nCurrent best bid is $" +
                                        String.format("%.2f", selected.getBestBid()) +
                                        " by " + best.getName());
                    } else {
...
class Order {
    ...
    public String toString() {
        ...
        if (assignedDelivery == null) {
            ...
            status = "Best: " + assignedDelivery.getName() + " $" + String.format("%.2f", bestBid);
        }
